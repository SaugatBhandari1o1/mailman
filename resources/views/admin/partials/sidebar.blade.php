            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{asset('uploads/profile/'.Auth::user()->profile)}}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('admin.index')}}" class="nav-link {{$current_route=='admin.index'? 'active':''}}"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="{{route('form')}}" class="nav-link {{$current_route=="form"? 'active':''}}"><i class="fa fa-keyboard me-2"></i>Forms</a>
